package com.github.abigail830.wishlistjpa.util.swagger;
...
//		pars.add(appIdPt.build());
		return new Docket(DocumentationType.SWAGGER_2)
				.apiInfo(apiInfo())
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.github.abigail830.wishlistjpa.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("WishList backend")
				.description("WishList backend")
